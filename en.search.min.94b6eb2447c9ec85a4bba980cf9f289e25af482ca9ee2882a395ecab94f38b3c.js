...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d6ba3c96b9fb283c3a866d0b7a345b1dbd8d4ffc8ad5190f65aab08d7e77e2ff.js',function(){input.required=false;search();});}
